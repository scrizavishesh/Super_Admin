...
console.log('my new date ',reqDate)
// ##### validation states ########## 
  ...
  const showName = async () => {
    try {
      ...
      console.log('get-all-api-data000',response)
  ...
  const GetByIdApi = async (id) => {
    ...
    try {
      ...
      console.log('get-by-id-in-request-module',response)
  ...
  return (
    <Container>
          ...
          <div className="breadCrum ms-2">
            <nav style={{ '--bs-breadcrumb-divider': "'>'" }} aria-label="breadcrumb">
              <ol class="breadcrumb ms-2">
                ...
                <li class="breadcrumb-item breadcrum-li heading-14" ><Link href="#">Request</Link></li>
              </ol>
            </nav>
          </div>
          ...
          <div className='d-flex g-1 for-media-query'>
            <form class="row  me-2">
              <div class="col-9 for-media-query-22">
                <input type="password" class="form-control form-control-sm form-focus" style={{ fontSize: '15px', width: '283px' }} id="inputPassword2" placeholder="01/01/2024 - 02/10/2024" />
              </div>
              <div class="col-3 p-0 ps-2" >
                <button type="submit" class="btn btn-primary mb-3 heading-1 remove-shadow button-bg-color heading-14" style={{ border: '1px solid #008479', lineHeight: '1.3' }}>
            ...
            <div className='me-2'>
              <div class="input-group mb-3 ">
                <input type="text" class="form-control form-focus font-color" style={{ height: '34px' }} placeholder="Search" aria-label="Recipient's username" aria-describedby="basic-addon2" />
                <span class="input-group-text button-bg-color button-color heading-14 font-color " style={{ cursor: 'pointer', height: "34px" }} id="basic-addon2">Search</span>
              </div>
            </div>
          </div>
...

                {
                  data.map(item => (
                    <tr key={item.id} className='heading-14 my-bg-color  align-middle'>
                      ...
                      <td className='  greyText'>{item.id}</td>
                      <td className='  greyText'>{item?.reqDate.slice(0,10) }</td>
                      <td className='  greyText'>{item.reqDesc}</td>
                ...
                <div class="mb-3 my-div-class">
                  ...
                  <p className='heading-14'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.!
                    ...
                    <div className='my-button22 '>
                      <button type="button" class="btn btn-outline-success" onClick={(e) => PutDataApi(putstate)}>Send</button>
      ...
      {/* <div class="mb-3">
        ...
        <input type="text" class="form-control form-focus input-bg label-color" value={reqid}  style={{ marginTop: '-4px' }} id="exampleFormControlInput1" placeholder="SCR152" />
      </div> */}
      
    <div class="mb-3">
       <label for="exampleFormControlInput1" class="form-label label-color ">Date</label>
       <input type="text" class="form-control form-focus " value={reqDate} style={{ marginTop: '-4px' }} id="exampleFormControlInput1" placeholder="01 Feb 2023" disabled/>
       </div>
      ...
      <select class="form-select form-focus" value={reqstatus}  onChange={(e) =>handleStatusChange(e.target.value)} aria-label="Default select example">
        {/* <option selected >{`${putdata.reqStatus === 'Active' ? 'Active' : 'InActive'}`}</option> */}
                  ...
                  <div className="sure-main-container mt-4">
                    <div className="sure-container">
                      ...
                      <div className="form-check mt-1">
                        <input className="form-check-input my-red-tick" type="checkbox" value="" id="flexCheckDefault" />
                      ...
                      <div className="mt-4">
                        <button type="button" className="btn btn-outline-primary button00" onClick={(e) => DeleteApi(delvalue)}>Delete</button>
